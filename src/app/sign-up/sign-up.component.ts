        ...
        this.expanseService
            ...
            .then(() =>
                this.expanseService.signup(
                    ...
                    this.password,
                    moment(
                        new Date(this.selectedYears, this.months.indexOf(this.selectedMonth), this.selectedDays).getTime()
                    ).format()
                )
            )
            .then((resp: any) => {
                ...
                if (!resp.error) {
                    ...
                    return fetch(
                        this.expanseService.discordURl + '/new_user/' + resp.users_id + '/' + this.name + '/' + this.email
